  ...
  return (
    <div className='w-[90%] mx-auto min-h-screen text-white flex items-center'>
      <div className='h-full w-full flex flex-col justify-center items-center gap-2'>
        <Typography as="h3" size="h3" className=' parallaxText text-center font-euro-semibold'>The Art</Typography>
        <Typography as="p" size="base" className='parallaxText text-center font-euro-light'>Who We Are</Typography>
        <Typography as="p" size="md" className='parallaxText text-center font-euro-semibold text-primary-orange mt-1'>01</Typography>
