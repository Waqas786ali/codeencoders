        ...
        >
          ...
          <div className="w-full h-full p-8 flex flex-col justify-between">
            ...
            <ul className="flex flex-col items-center gap-8 text-dark-blue font-euro-light">
              <li className="flex items-center gap-5 overflow-hidden">
                <span className="text_apear_menu bg-primary-blue size-5 rounded-full"></span>
                <Link className="text_apear_menu" onClick={toggleMenu} to="/"><Typography as="p" size="h2" className="font-euro-semibold text-primary-blue">Home</Typography></Link>
              </li>
